Veewee::Definition.declare({
  ...
  :boot_cmd_sequence => [ 
    ...
    'p' + 'Vagrant1234!<Enter>' * 2,		# Configure temporary root passwd
    't<Enter>q',				# Configure /etc/fstab
    'z<Down><Enter>' + '<Down>' * 84 + '<Wait><Enter><Enter>',	# Configure /etc/fstab
    'nh' + '<Delete>' * 9 + 'vagrant.com<Enter>',	# Set hostname
  ...
  :ssh_login_timeout => "10000", :ssh_user => "root", :ssh_password => "Vagrant1234!", :ssh_key => "",
